...
solo archivo.
para generar un autFile ir a la consola y hacer un tsc --outFile nombreDelNuevoArchivo.js app app2
esto crea un solo archivo pero con el codigo de los 2 archivos.ts que en este caso son app y app2
*/

// ***************    Detectar cambios en cualquier archivo   ***************
// tsc -w
